...
def main():
    ...
    if choice == "SVM Prediction Model": 
        ...
        st.info("This model was trained using the SVM algorithm , TF-IDF vectorizor and the oversampled dataset.")
    ...
    if choice == "KNN Prediction Model": 
        ...
        st.info("This model was trained using the KNN algorithm , TF-IDF vectorizor and the oversampled dataset.")
        st.info("The accuracy of this model reaches up to 99% !")
    ...
    if choice == "LogisticRegression Prediction Model": 
        ...
        st.info("This model was trained using the LogisticRegression algorithm , TF-IDF vectorizor and the oversampled dataset.")
        st.info("The accuracy of this model reaches up to 99% !")
    ...
    if choice == "RandomForest Prediction Model": 
        ...
        st.info("This model was trained using the RandomForest algorithm , TF-IDF vectorizor and the oversampled dataset.")
        st.info("The accuracy of this model reaches up to 99% !")
